...
parser.add_argument(
    "--model", default="gym_cartpole_model.pt", type=str, help="Output model path."
)
...
class Model(npfl138.TrainableModule):
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.model = torch.nn.Sequential(
            torch.nn.Linear(GymCartpoleDataset.FEATURES, 128),
            torch.nn.ReLU(),
            torch.nn.Linear(128, 2),  # Output layer: 2 logits for left/right action
        )
